...
it('lets user2 buy a star and decreases its balance in ether', async() => {
  ...
  it('can add the star name and star symbol properly', async() => {
      ...
      let tokenId = 6;
      let instance = await StarNotary.deployed();
      await instance.createStar('Awesome Star2!', tokenId, {from: accounts[0]})
      assert.equal(await instance.tokenIdToStarInfo.call(tokenId), 'Awesome Star2!')
  ...
  it('lets 2 users exchange stars', async() => {
      ...
      let instance = await StarNotary.deployed();
      let tokenId1 = 7;
      await instance.createStar('Awesome Star1!', tokenId1, {from: accounts[0]})
      let tokenId2 = 8;
  ...
  it('lookUptokenIdToStarInfo test', async() => {
      ...
      let tokenId = 10;
      await instance.createStar('Awesome Star1!', tokenId, {from: accounts[0]})
      assert.equal(await instance.lookUptokenIdToStarInfo.call(tokenId), 'Awesome Star1!');
  });
